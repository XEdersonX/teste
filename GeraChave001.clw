   ...
   INCLUDE('ABWINDOW.INC'),ONCE
                     ...
                     MAP
                       INCLUDE('GERACHAVE001.INC'),ONCE        !Local module procedure declarations
                       INCLUDE('GERACHAVE002.INC'),ONCE        !Req'd for module callout resolution
                     END
...
AppFrame             APPLICATION('Application'),AT(,,310,192),RESIZE,MAX,STATUS(-1,80,120,45),SYSTEM,IMM
                       MENUBAR
